...
public interface StudentProfileMapper {
     ...
     * 根據id查詢學生信息
     */
    @Select("select kg_studentprofileid,kg_classname,kg_schoolname,kg_educationnumber,kg_studentnumber,kg_name,kg_fullname,kg_sex,kg_age,kg_countryname,to_char(kg_birthday,'yyyy-mm-dd') kg_birthday,kg_registeredresidence,kg_passportnumberoridnumber,kg_entrancestate,kg_status,to_char(kg_jointime,'yyyy-mm-dd') kg_jointime from KG_STUDENTPROFILE where kg_studentprofileid = #{id} and KG_STATE = 0")
    @Results({
            ...
            @Result(property = "kg_status", column = "KG_STATUS"),
     ...
     * 根據学号或者学籍号查詢學生信息
     */
    @Select("select kg_studentprofileid,kg_classname,kg_schoolname,kg_educationnumber,kg_studentnumber,kg_name,kg_fullname,kg_sex,kg_age,kg_countryname,to_char(kg_birthday,'yyyy-mm-dd') kg_birthday,kg_registeredresidence,kg_passportnumberoridnumber,kg_entrancestate,kg_status,to_char(kg_jointime,'yyyy-mm-dd') kg_jointime from KG_STUDENTPROFILE where (kg_educationnumber = #{eduNumber} or kg_studentnumber = #{stuNumber}) and KG_STATE = 0")
    @Results({
            @Result(property = "kg_studentprofileid", column = "KG_STUDENTPROFILEID"),
            @Result(property = "kg_classname", column = "KG_CLASSNAME"),
            @Result(property = "kg_schoolname", column = "KG_SCHOOLNAME"),
     ...
     * 新增學生信息
     */
    @Insert("insert into KG_STUDENTPROFILE(kg_classname,kg_schoolname,kg_educationnumber,kg_studentnumber,kg_name,kg_fullname,kg_sex,kg_age,kg_countryname,kg_birthday,kg_registeredresidence,kg_passportnumberoridnumber,kg_entrancestate,kg_status,kg_jointime) values (#{kg_classname},#{kg_schoolname},#{kg_educationnumber},#{kg_studentnumber},#{kg_name},#{kg_fullname},#{kg_sex},#{kg_age},#{kg_countryname},to_date(#{kg_birthday},'yyyy-mm-dd'),#{kg_registeredresidence},#{kg_passportnumberoridnumber},#{kg_entrancestate},#{kg_status},to_date(#{kg_jointime},'yyyy-mm-dd'))")
